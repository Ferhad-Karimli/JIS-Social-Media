        ...
        <div className={style.sub_posts}>
          ...
          <div className={style.conclusion}>
            <div className={style.videos}>
              <div className={style.v_numbers}>360</div>

              <p className={style.p_words}>videos</p>
            </div>

            <div className={style.images}>
              <div className={style.v_numbers}>180</div>

              <p className={style.p_words}>Images</p>
            </div>
            <div className={style.carusels}>
              <div className={style.v_numbers}>75</div>

              <p className={style.p_words}>carusels</p>
            </div>
          </div>
        </div>
      </div>
